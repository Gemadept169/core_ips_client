...
class Sot final {
 public:
  ...
  typedef WithAsyncMethod_Track<Service > AsyncService;
  template <class BaseClass>
  ...
  typedef WithCallbackMethod_Track<Service > CallbackService;
  ...
  typedef WithSplitStreamingMethod_Track<Service > StreamedService;
};
